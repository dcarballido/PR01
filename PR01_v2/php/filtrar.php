...
while ($row1 = mysqli_fetch_array($result_fs1)) {
		echo "<tr>
			<td>".$row1['nom_sala']."</td><td>".$row1['tlf_sala']."</td><td>".$row1['edificio_sala']."</td><td>".$row['disponibilidad']."</td>
		</tr>";
...
while ($row2 = mysqli_fetch_array($result_fr1)) {
		echo "<tr>
			<td>".$row2['id_recurs']."</td><td>".$row2['nom_recurs']."</td><td>".$row2['tipo_recurs']."</td><td>".$row['disponibilidad']."</td>
		</tr>";
...
<div id="filter">	
		...
		<a href="insert_reserva.php" style="margin-left: 32px;"><button>RESERVAR</button></a><br><br>
